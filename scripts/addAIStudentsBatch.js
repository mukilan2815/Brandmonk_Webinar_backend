...
// New Artificial Intelligence students for June MES batch
// These will be assigned certificate IDs starting from BMAJUNAIMES/Q0806S001
  ...
  try {
    ...
    existingStudents.forEach(s => {
      if (s.certificateId && s.certificateId.startsWith(CERT_PREFIX)) {
        const match = s.certificateId.match(/Q0806S(\d+)/);
        if (match) {
    ...
    for (const name of newStudentNames) {
      ...
      // Skip if name already exists in AI course
    ...
    console.log(`📈 Total AI students in DB: ${finalCount}`);
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
